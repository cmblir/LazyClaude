...
from .lazyclaw_proxy import (
    api_lc_agent, api_lc_auth_add, api_lc_auth_list, api_lc_auth_remove,
    api_lc_auth_use, api_lc_browse, api_lc_clear_session, api_lc_config_delete,
    api_lc_config_get, api_lc_config_set, api_lc_cron_add, api_lc_cron_list,
    api_lc_cron_remove, api_lc_cron_run, api_lc_cron_sync, api_lc_daemon_start,
    api_lc_daemon_status, api_lc_daemon_stop, api_lc_doctor, api_lc_export,
    api_lc_graph, api_lc_import, api_lc_inspect, api_lc_message_add,
    api_lc_message_list, api_lc_message_remove, api_lc_message_send,
    api_lc_nodes_list, api_lc_nodes_register, api_lc_nodes_remove,
    api_lc_onboard, api_lc_pairing_add, api_lc_pairing_list,
    api_lc_pairing_remove, api_lc_rates_delete, api_lc_rates_list,
    api_lc_rates_set, api_lc_resume, api_lc_run, api_lc_setup_status,
    api_lc_status, api_lc_validate, api_lc_version, api_lc_workspace_get,
    api_lc_workspace_init, api_lc_workspace_list, api_lc_workspace_remove,
    api_lc_workspace_save, cli_available,
)
...
ROUTES_GET: dict[str, Callable[[dict], Any]] = {
    ...
    # v3.99.26 — lazyclaw CLI parity (read-side)
    "/api/lc/available": lambda q: {"ok": True, "available": cli_available()},
    "/api/lc/config": api_lc_config_get,
    "/api/lc/rates": api_lc_rates_list,
    "/api/lc/auth": api_lc_auth_list,
    "/api/lc/pairing": api_lc_pairing_list,
    "/api/lc/nodes": api_lc_nodes_list,
    "/api/lc/message": api_lc_message_list,
    "/api/lc/cron": api_lc_cron_list,
    "/api/lc/workspace/list": api_lc_workspace_list,
    "/api/lc/workspace/get": api_lc_workspace_get,
    "/api/lc/doctor": api_lc_doctor,
    "/api/lc/status": api_lc_status,
    "/api/lc/version": api_lc_version,
    "/api/lc/daemon/status": api_lc_daemon_status,
    "/api/lc/setup/status": api_lc_setup_status,
    "/api/lc/export": api_lc_export,
    "/api/lc/inspect": api_lc_inspect,
...
ROUTES_POST: dict[str, Callable[[dict], Any]] = {
    ...
    # v3.99.26 — lazyclaw CLI parity (write-side)
    "/api/lc/config/set":         api_lc_config_set,
    "/api/lc/config/delete":      api_lc_config_delete,
    "/api/lc/rates/set":          api_lc_rates_set,
    "/api/lc/rates/delete":       api_lc_rates_delete,
    "/api/lc/auth/add":           api_lc_auth_add,
    "/api/lc/auth/remove":        api_lc_auth_remove,
    "/api/lc/auth/use":           api_lc_auth_use,
    "/api/lc/pairing/add":        api_lc_pairing_add,
    "/api/lc/pairing/remove":     api_lc_pairing_remove,
    "/api/lc/nodes/register":     api_lc_nodes_register,
    "/api/lc/nodes/remove":       api_lc_nodes_remove,
    "/api/lc/message/add":        api_lc_message_add,
    "/api/lc/message/remove":     api_lc_message_remove,
    "/api/lc/message/send":       api_lc_message_send,
    "/api/lc/cron/add":           api_lc_cron_add,
    "/api/lc/cron/remove":        api_lc_cron_remove,
    "/api/lc/cron/sync":          api_lc_cron_sync,
    "/api/lc/cron/run":           api_lc_cron_run,
    "/api/lc/workspace/save":     api_lc_workspace_save,
    "/api/lc/workspace/init":     api_lc_workspace_init,
    "/api/lc/workspace/remove":   api_lc_workspace_remove,
    "/api/lc/agent":              api_lc_agent,
    "/api/lc/browse":             api_lc_browse,
    "/api/lc/onboard":            api_lc_onboard,
    "/api/lc/daemon/start":       api_lc_daemon_start,
    "/api/lc/daemon/stop":        api_lc_daemon_stop,
    "/api/lc/run":                api_lc_run,
    "/api/lc/resume":             api_lc_resume,
    "/api/lc/clear":              api_lc_clear_session,
    "/api/lc/validate":           api_lc_validate,
    "/api/lc/graph":              api_lc_graph,
    "/api/lc/import":             api_lc_import,
}
