...
# v3.99.x — Auto-Resume add-binding dialog spawnFallback toggle (dist/app.js).
try:
    from translations_manual_46 import NEW_EN as _NEW_EN_46, NEW_ZH as _NEW_ZH_46
except Exception:
    _NEW_EN_46, _NEW_ZH_46 = {}, {}

# v3.99.46 — Auto-Resume binding form resume-delay selector (dist/app.js).
try:
    from translations_manual_47 import NEW_EN as _NEW_EN_47, NEW_ZH as _NEW_ZH_47
except Exception:
    _NEW_EN_47, _NEW_ZH_47 = {}, {}

# v3.99.x — Usage tab live "today" token widget (dist/app.js).
try:
    from translations_manual_48 import NEW_EN as _NEW_EN_48, NEW_ZH as _NEW_ZH_48
except Exception:
...
# v3.99.x — Auto-Resume diagnose modal + Plugin Hub tab.
try:
    from translations_manual_51 import NEW_EN as _NEW_EN_51, NEW_ZH as _NEW_ZH_51
except Exception:
    _NEW_EN_51, _NEW_ZH_51 = {}, {}
...
for _k, _v in _NEW_ZH_45.items():
    MANUAL_ZH.setdefault(_k, _v)
for _k, _v in _NEW_EN_46.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_46.items():
    MANUAL_ZH.setdefault(_k, _v)
for _k, _v in _NEW_EN_47.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_47.items():
    MANUAL_ZH.setdefault(_k, _v)
...
for _k, _v in _NEW_ZH_50.items():
    MANUAL_ZH.setdefault(_k, _v)
for _k, _v in _NEW_EN_51.items():
    MANUAL_EN.setdefault(_k, _v)
for _k, _v in _NEW_ZH_51.items():
    MANUAL_ZH.setdefault(_k, _v)
